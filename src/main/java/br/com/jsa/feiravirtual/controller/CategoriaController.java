...
public class CategoriaController {
	...
	@PostMapping(value = "/salvarSubcategoriaInCategoria", consumes = MediaType.APPLICATION_JSON)
	public Response salvarSubcategoriaInCategoria(@RequestBody Categoria categoria) {
		categoriaService.salvarSubcategoriaInCategoria(categoria);
		return Response.ok().entity(categoria).build();
	}
	...
	public Optional<Categoria> getCategoria(@PathVariable("id") String idCategoria) {
